    ...
    var dateTimePicker = function (element, options) {
        var picker = {},
            ...
            getTimePickerMainTemplate = function () {
                ...
                if (!use24Hours) {
                    topRow.append($('<td>').append($('<a onclick="onCalendarClose()">' + '<i class="glyphicon glyphicon-remove">').addClass('close-calender')));
                    middleRow.append($('<td>')
            ...
            getTemplate = function () {
                ...
                if (options.sideBySide && hasDate() && hasTime()) {
                    ...
                    template.append(
                        $('<div>').addClass('row')
                            .append(dateView.addClass('col-md-7'))
                            .append(timeView.addClass('col-md-5'))
                    );
