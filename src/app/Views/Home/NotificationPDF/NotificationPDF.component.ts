...
@Component({
    selector: 'app-home',
  templateUrl: './NotificationPDF.component.html',
  styleUrls: ['./NotificationPDF.component.css'],
    standalone: false
})

export class NotificationPDFComponent implements OnInit {
  ...
  downloadPdf(fileName: string) {
    ...
    const url = this.docUrl + '/Content/pdf/' + fileName.replace('~/', '');
