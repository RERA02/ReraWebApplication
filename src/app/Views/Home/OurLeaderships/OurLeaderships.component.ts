...
@Component({
  selector: 'app-OurLeaderships',
  templateUrl: './OurLeaderships.component.html',
  styleUrls: ['./OurLeaderships.component.css'],
    standalone: false
})

export class OurLeadershipsComponent implements OnInit {
