...
@Component({
  selector: 'app-DisclaimerAndPolicies',
  templateUrl: './DisclaimerAndPolicies.component.html',
  styleUrls: ['./DisclaimerAndPolicies.component.css'],
    standalone: false
})

export class DisclaimerAndPoliciesComponent implements OnInit {
