...
export class AppsettingService {
  ...
  public mvcUrl: string = "";
  public DocumentUrl: string = "";
  public ssoAuthenticationURL: string = "";
  ...
  setAppsetting(appsetting: any): any {
    ...
    this.mvcUrl = appsetting?.ApiUrls?.BaseURLMvc;
    this.DocumentUrl = appsetting?.ApiUrls?.DocumentPath;
    this.ssoAuthenticationURL = appsetting?.ApiUrls?.SSOAuthenticationURL;
    ...
    this.WebURL = appsetting?.ApiUrls?.WebURL;
    ...
    //ImagePathURL = "http://localhost:4200/imagefile/"
